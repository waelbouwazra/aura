 ...
 */
final class Version20230301204831 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE partenaire (id INT AUTO_INCREMENT NOT NULL, cin VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE terrain (id INT AUTO_INCREMENT NOT NULL, id_partenaire_id INT DEFAULT NULL, surface DOUBLE PRECISION NOT NULL, adresse VARCHAR(255) NOT NULL, potentiel DOUBLE PRECISION NOT NULL, INDEX IDX_C87653B126F6C2C9 (id_partenaire_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
